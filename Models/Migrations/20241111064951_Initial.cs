    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6249), "fruits.jpg", true, "Fruits" },
                    { 2, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6266), "vegetables.jpg", true, "Vegetables" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6402), "admin@example.com", null, false, null, "Admin User", "admin123", null, "Admin", "admin", null },
                    { 2, null, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6405), "user@example.com", null, false, null, "Regular User", "user123", null, "User", "user", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6374), "Fresh red apples", "apple.jpg", true, "Apple", 1.50m, 100 },
                    { 2, 2, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6383), "Organic carrots", "carrot.jpg", true, "Carrot", 0.80m, 200 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6443), "ORD001", 1, 1, 2, "Pending", 1 },
                    { 2, new DateTime(2024, 11, 11, 13, 49, 50, 819, DateTimeKind.Local).AddTicks(6446), "ORD002", 1, 2, 3, "Completed", 2 }
                });
